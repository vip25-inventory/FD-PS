...
import PyramidCourseRegistration from './components/pages/pyramid/PyramidCourseRegistration';
import SpectrumCourseRegistration from './components/pages/spectrum/SpectrumCourseRegistration';
