...
import './SpectrumAbout.css'; // New CSS file for About page specific styles
            ...
            <div className="col-lg-6 col-md-12 mb-4 mb-lg-0">
              <div className="about-card">
                ...
                <p className="text-justify">
                  To become the most trusted tuition centre for <b style={{ color: '#2a50a2' }}>CBSE, ICSE, </b> and <b style={{ color: '#2a50a2' }}>State Board students </b> by delivering quality education and measurable academic success.
                </p>
              </div>
            </div>
...
========================== */}
        ...
        <div className="section cta-section">
          <div className="cta-content text-center">
            <h2 style={{ color: 'black', fontSize: '1.3rem', fontWeight: 'bold' }}>Join with <b style={{ color: '#2a50a2' }}>Spectrum</b> Family</h2>
