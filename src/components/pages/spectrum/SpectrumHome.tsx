...
// Spectrum-specific hero banner images from /public/spectrum-banners/
const spectrumHeroBanners = [
  { src: '/spectrum-banners/banner-4.jpg', alt: 'Spectrum Banner' },
  { src: '/spectrum-banners/banner-1.jpg', alt: 'Spectrum Banner' },
  { src: '/spectrum-banners/neet.webp',    alt: 'NEET Coaching' },
  { src: '/spectrum-banners/iit-jee.jpg',  alt: 'IIT-JEE Coaching' },
  { src: '/spectrum-banners/academics.png',alt: 'Academics' },
];
...
const SpectrumHome: React.FC = () => {
      ...
      .then(data => {
        if (data && !data.error) {
          ...
          if (data.banner_images && Array.isArray(data.banner_images) && data.banner_images.length > 0) {
            ...
            setBanners(spectrumHeroBanners);
          }
        } else {
  ...
  const handleScholarshipTabClick = (tab: string) => {
    ...
    navigate('/spectrum/course-registration');
  };
