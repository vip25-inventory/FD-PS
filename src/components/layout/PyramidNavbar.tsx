        ...
        <div className="header-inner">
          ...
          <nav className={`main-navigation ${showMobileMenu ? 'show' : ''}`}>
            <ul className="nav-menu">
              <li className="menu-item">
                <Link to="/pyramid" onClick={handleMobileLinkClick}>Home</Link>
              </li>
            ...
            {isMobile && (
              <div className="header-actions mobile-header-actions">
                <Link to="/pyramid/course-registration" className="btn-callback" title="Register" aria-label="Register" onClick={handleMobileLinkClick}>
                  <img src="/form-6.png" alt="Register" style={{ width: "16px", height: "16px" }} />
                  <span>Register</span>
                </Link>
                <Link to="/pyramid/contact" className="btn-callback" title="Request a call back" aria-label="Request a call back" onClick={handleMobileLinkClick}>
          ...
          {!isMobile && (
            <div className="header-actions">
              <Link to="/pyramid/course-registration" className="btn-callback" title="Register" aria-label="Register">
                <img src="/form-6.png" alt="Register" style={{ width: "18px", height: "18px" }} />
              </Link>
              <Link to="/pyramid/contact" className="btn-callback" title="Request a call back" aria-label="Request a call back">
                <i className="fas fa-phone"></i>
              </Link>
