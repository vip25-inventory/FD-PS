        ...
        <div className="header-inner">
          ...
          <nav className={`main-navigation ${showMobileMenu ? 'show' : ''}`}>
            <ul className="nav-menu">
              <li className="menu-item">
                <Link to="/spectrum" onClick={handleMobileLinkClick}>Home</Link>
              </li>
              <li className="menu-item">
          ...
          {!isMobile && (
            <div className="header-actions">
              <Link to="/spectrum/course-registration" className="btn-callback" title="Register" aria-label="Register">
                <img src="/form-6.png" alt="Register" style={{ width: "18px", height: "18px" }} />
              </Link>
              <Link to="/spectrum/contact" className="btn-callback" title="Request a call back" aria-label="Request a call back">
                <i className="fas fa-phone"></i>
              </Link>
